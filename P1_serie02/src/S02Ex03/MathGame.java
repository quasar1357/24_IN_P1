...
public class MathGame {
    ...
    public static void main(String[] args) {
        ...
        // Second value is at max. the difference between the MAX the first value
        ...
        // Calculate the sum and check if the guess is correct
    ...
    public static int getInputInt(Scanner valScanner, int minIn, int maxIn){
        ...
        // Repeat until the input is within the specified range
